...
if has('nvim')
    " Treesitter config
    augroup TreesitterConfig
        au!
        lua << EOF
        require'nvim-treesitter.configs'.setup {
          -- A list of parser names, or "all" (the five listed parsers should always be installed)

          ensure_installed = { "c", "cpp", "html", "jq", "json", "make", "lua", "vim", "vimdoc", "query", "php", "phpdoc", "javascript", "bash", "python", "sql", "ssh_config", "regex", "gitignore", "gitcommit", "diff", "csv", "css", "dockerfile" },
